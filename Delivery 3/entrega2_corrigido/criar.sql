...
CREATE TABLE Promocao(
    ...
    tipoPromocoes  VARCHAR(50) CONSTRAINT n_tipoPromocoes CHECK((tipoPromocoes = 'codigoPromocao') OR (tipoPromocoes = 'boasVindas') OR (tipoPromocoes = 'boasFestas') OR (tipoPromocoes = 'entregasFelizes') OR (tipoPromocoes = 'BonsExames') OR (tipoPromocoes = 'BonsVicios'))
);
